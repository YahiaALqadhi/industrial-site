...
@section('page_subtitle', 'Add a new service page for the public website')
        ...
        <div class="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-xl shadow-slate-900/5">
            <div class="border-b border-slate-200 px-6 py-5">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Add title, slug, descriptions, order, and publication status.
                </p>
            </div>
            ...
            <div class="grid gap-5 p-6 md:grid-cols-2">
                <div class="md:col-span-2">
                    ...
                    <input class="field mt-2" name="title" value="{{ old('title') }}" required placeholder="Service title">
                ...
                <div>
                    ...
                    <input class="field mt-2" name="slug" value="{{ old('slug') }}" placeholder="auto-generated">
                ...
                <div>
                    ...
                    <input type="number" min="0" class="field mt-2" name="sort_order" value="{{ old('sort_order', 0) }}">
                ...
                <div class="md:col-span-2">
                    ...
                    <input class="field mt-2" name="short_desc" value="{{ old('short_desc') }}" placeholder="Brief service summary shown on cards">
...
<textarea
    ...
    name="description"
    rows="7"
    placeholder="Detailed service description shown on the website"
    data-lenis-prevent
>{{ old('description') }}</textarea>                    <x-input-error :messages="$errors->get('description')" class="mt-2 text-sm text-[#711726]" />
                </div>
            ...
            <div class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-xl shadow-slate-900/5">
                ...
                <div class="mt-5 overflow-hidden rounded-3xl border border-slate-200 bg-slate-50">
                    <template x-if="preview">
                        <img :src="preview" class="h-56 w-full object-cover" alt="Service preview">
                    </template>
                    ...
                    <div x-show="!preview" class="flex h-56 flex-col items-center justify-center px-6 text-center text-sm text-slate-400">
                        ...
                        <div class="mt-1 text-xs">Upload a clean industrial service image.</div>
                    </div>
                </div>
